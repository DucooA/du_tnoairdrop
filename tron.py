...
BOT_TOKEN = "7495850897:AAFgH1Y7IKD_nvpG1-fWiYCm5FECEVt4M_c"
PAYMENT_CHANNEL = "@TNOcoin_withdrawal" #add payment channel here including the '@' sign
OWNER_ID = 2076385698 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@TNOcoin_withdrawal", "@TNOcoin_community"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
